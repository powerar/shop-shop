...
export function idbPromise(storeName, method, object) {
  return new Promise((resolve, reject) => {
    ...
    request.onsuccess = function (e) {
      ...
      //check which value we passed into the function as a mtethod, and perform that method on the object store
      switch (method) {
        case 'put':
          store.put(object);
          resolve(object);
      ...
      //when the transaction is comlete, close the connection
